...
.then((data) => {
    getIngMes(data)
     ...
     divHeader.textContent=data.strMeal;
     ...
     para.textContent=data.strInstructions
     console.log(data.strInstructions)
     mealRecipe.appendChild(para)
     mealVideo.innerHTML=`<iframe class="iframe_video" src="${data.strYoutube}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`   
